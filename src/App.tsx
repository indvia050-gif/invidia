    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-auto bg-gray-50">
          ...
          {currentPage === 'profile' && (
            <div className="max-w-7xl p-1 border border-gray-200 rounded-xl px-2">
              <div className="mb-6 flex items-center justify-between">
                <div>
                  <h1 className="text-3xl font-bold text-[#5D586C]">Customer Profile</h1>
                  <p className="text-sm text-[#6F6B7D] mt-1">View and analyze detailed customer information across all attributes</p>
                </div>
                <div className="flex items-center gap-3">
                  <span className="text-sm text-[#6F6B7D]">last synced with shopify</span>
                  <button className="flex items-center gap-2 px-4 py-2 text-[#6F6B7D] bg-white text-sm border border-gray-200 rounded-lg">
                    <Plus className="w-4 h-4" />
                    Add Contact
                  </button>
                </div>
              ...
              <div className="grid grid-cols-4 mb-4 bg-white border border-gray-200 rounded-lg">
                {customerMetrics.map((metric, idx) => (
                  <div key={idx} className=" px-6 py-4 border-r border-gray-200 my-4">
                    <div className="text-3xl font-semibold text-[#5D586C]">{metric.value}</div>
                    <div className="text-sm text-[#6F6B7D] mt-2">{metric.label}</div>
                  </div>
                ))}
              </div>
                ...
                <div className="grid grid-cols-5 gap-2">
                  {filterOptions.map((filter, idx) => (
                    <div key={idx}>
                      ...
                      <select className="w-full px-2 py-2 border border-gray-300 rounded-lg">
          ...
          {(currentPage === 'dashboard' || currentPage === 'analytics' || currentPage === 'playbooks' || currentPage === 'settings') && (
            <div className="flex-1 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-[#6F6B7D]">This page is under development</p>
              </div>
            </div>
          )}
        </div>
