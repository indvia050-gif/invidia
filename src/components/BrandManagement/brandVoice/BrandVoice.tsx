...
const steps: Step[] = [
  ...
  },
  {
    ...
    description:
      "Define your market segment and discover consumer pain points.",
    icon: "target.png",
  },
];
...
const benefits = [
  {
    ...
    description:
      "Get campaign suggestions tailored to your brand personality and growth goals.",
    icon: "targetcustomer.png",
  },
  {
    title: "Consistent Voice",
    description:
      "Maintain consistent communication style across all your marketing channels.",
    icon: "voice.png",
  },
  {
    title: "Better Results",
    description:
      "Achieve higher engagement with content that resonates with your audience",
    icon: "results.png",
  },
];
  ...
  return (
    <div className="border rounded-xl bg-gray-50 p-3">
      <div className="mb-3">
        ...
        <p className="text-[#5D586C]">
          Help Us Understand Your Brand To Create Personalized Campaigns And
          Content.
        </p>
      </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-3 mb-6">
        <div className="mb-6">
          <h2 className="text-2xl font-semibold text-[#5D586C] mb-3">
            Discover your brand identity
          </h2>
          <p className="text-sm text-[#5D586C] mb-6">
            Take our 8-step questionnaire to help us understand your unique
            brand story,goals and personality.This will enable us to provide
            personalized campaign suggestions and content recommendations.
          </p>
        </div>

        <div className="mb-2">
          <h3 className="text-base font-semibold text-[#5D586C] mb-2">
            Completion Progress
          </h3>
          <button
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-3 mb-3">
        <div className="mb-6">
          <h2 className="text-2xl font-semibold text-[#5D586C] mb-2">
            What We'll Discover Together
          </h2>
          <p className="text-sm text-[#5D586C]">
            Our questionnaire covers 8 key areas to build your complete brand
            profile
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          {steps.map((step) => (
            ...
            >
              <img src={step.icon} className="h-10 w-10" />
              <div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-3">
        <div className="grid grid-cols-3 gap-8">
          {benefits.map((benefit, index) => (
            ...
            >
              <img src={benefit.icon} className="h-12 w-12" />
              <div className="flex-1">
                <h3 className="font-semibold text-[#5D586C] ">
                  {benefit.title}
                </h3>
                <p className="text-sm text-[#5D586C] leading-relaxed">
                  {benefit.description}
                </p>
              </div>
            </div>
